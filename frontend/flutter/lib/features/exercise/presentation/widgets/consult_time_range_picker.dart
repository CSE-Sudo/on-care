...
Future<TimeRangeValue?> showConsultTimeRangePicker({
  ...
  return showAppTimeRangePicker(
    ...
    initialStart: start,
    initialEnd: end,
    labels: AppTimeRangePickerLabels(
      title: l.exTimeRangeTitle,
      startTime: l.exTimeRangeStartTime,
      endTime: l.exTimeRangeEndTime,
      startHourStep: l.exTimeRangeStartHourStep,
      startMinuteStep: l.exTimeRangeStartMinuteStep,
      endHourStep: l.exTimeRangeEndHourStep,
      endMinuteStep: l.exTimeRangeEndMinuteStep,
      am: l.exSlotAm,
      pm: l.exSlotPm,
      previousStep: l.exTimeRangePrevStep,
      nextStep: l.exTimeRangeNextStep,
      invalidEnd: l.exTimeRangeInvalidEnd,
