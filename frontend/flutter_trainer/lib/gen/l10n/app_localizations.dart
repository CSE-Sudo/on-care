...
abstract class AppLocalizations {
  ...
  /// Badge on the client detail header, and the dialog title, for a PT renewal discount coupon the member bought with points (#1787).
  ///
  /// In en, this message translates to:
  /// **'Renewal coupon'**
  String get clientRenewalCouponTitle;

  /// No description provided for @clientRenewalCouponOpen.
  ///
  /// In en, this message translates to:
  /// **'Review renewal coupon'**
  String get clientRenewalCouponOpen;

  /// No description provided for @clientRenewalCouponBenefitLabel.
  ///
  /// In en, this message translates to:
  /// **'Benefit'**
  String get clientRenewalCouponBenefitLabel;

  /// No description provided for @clientRenewalCouponBenefit.
  ///
  /// In en, this message translates to:
  /// **'₩10,000 off PT renewal'**
  String get clientRenewalCouponBenefit;

  /// No description provided for @clientRenewalCouponIssuedOn.
  ///
  /// In en, this message translates to:
  /// **'Redeemed on'**
  String get clientRenewalCouponIssuedOn;

  /// No description provided for @clientRenewalCouponExpiry.
  ///
  /// In en, this message translates to:
  /// **'Expires'**
  String get clientRenewalCouponExpiry;

  /// No description provided for @clientRenewalCouponExpiryValue.
  ///
  /// In en, this message translates to:
  /// **'{date} (D-{days})'**
  String clientRenewalCouponExpiryValue(String date, int days);

  /// No description provided for @clientRenewalCouponExpiryToday.
  ///
  /// In en, this message translates to:
  /// **'{date} (D-day)'**
  String clientRenewalCouponExpiryToday(String date);

  /// No description provided for @clientRenewalCouponWarning.
  ///
  /// In en, this message translates to:
  /// **'This can\'t be undone once used'**
  String get clientRenewalCouponWarning;

  /// No description provided for @clientRenewalCouponRedeem.
  ///
  /// In en, this message translates to:
  /// **'Mark as used'**
  String get clientRenewalCouponRedeem;

  /// No description provided for @clientRenewalCouponRedeemed.
  ///
  /// In en, this message translates to:
  /// **'Renewal coupon marked as used'**
  String get clientRenewalCouponRedeemed;

  /// No description provided for @clientRenewalCouponRedeemFailed.
  ///
  /// In en, this message translates to:
