...
///
/// PT 관리 신호(`signals`, #2204)는 서버가 계산하는 값이라 데모는 여기서 정한다.
/// 회원의 이야기와 맞춘다 — 단백질 부족은 근력 향상·체중 감량 회원에게만, 휴면
/// 회원(박성호·문가영)은 서버처럼 신호가 없다. 여덟 가지 배지가 모두 한 번은
/// 보이게 고른다(답장 대기는 스레드가 정한다).
